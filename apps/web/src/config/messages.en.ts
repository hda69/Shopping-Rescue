export const MESSAGES_EN = {
  ...
  pricing: {
    ...
    subtitle:
      'Start free to see your risk. Unlock a full audit when you need every finding — or subscribe if you want ongoing protection across one or many stores.',
    freeScan: 'Free Scan',
    ...
    perMonth: 'per month',
    freeBestFor: 'Best to diagnose quickly',
    fullBestFor: 'Best for a serious fix cycle',
    monitoringBestFor: 'Best for ongoing protection',
    agencyBestFor: 'Best for agencies & multi-brand',
    freeDescription:
      'A lightweight public crawl so you can see your risk score and sample findings before paying.',
    fullDescription:
      'Unlock the complete diagnostic for one store: every finding, evidence, checklist, and PDF — plus a free re-scan after you fix.',
    monitoringDescription:
      'Stay ahead of Merchant Center surprises with weekly scans, alerts, and a dashboard for up to 3 stores.',
    agencyDescription:
      'Run the same monitoring stack across up to 20 client or brand stores, with higher re-scan capacity.',
    freeFeatures: [
      '1 store',
      'Up to 15 pages + 20 products crawled',
      'Risk score 0–100',
    ...
    fullFeatures: [
      '1 store',
      'Up to 150 pages + 500 products',
      'All findings unlocked',
      'Evidence lines + recommendations',
      'Prioritized correction checklist',
      'Downloadable PDF report',
      '1 free re-scan after fixes',
      'Results kept for 12 months',
    ],
    monitoringFeatures: [
      'Up to 3 stores',
      'Everything useful from Full Audit depth on each weekly run',
      'Automatic scan every 7 days',
      'Email alerts on new high-risk findings',
      'Dashboard to manage stores & history',
      'Up to 2 manual re-scans per day',
    ...
    agencyFeatures: [
      ...
      'Up to 5 manual re-scans per day',
      'Built for agencies handling several Merchant Center accounts',
      'Same weekly cadence + alerts at scale',
    ],
    compareTitle: 'Side-by-side comparison',
    compareSub: 'The numbers that usually decide which plan to buy.',
    compareHeaders: {
      feature: 'Feature',
      free: 'Free',
      full: 'Full Audit',
    ...
    compareRows: [
      { feature: 'Stores included', free: '1', full: '1', monitoring: 'Up to 3', agency: 'Up to 20' },
      { feature: 'Pages crawled / scan', free: '15', full: '150', monitoring: '150', agency: '150' },
      { feature: 'Products analyzed / scan', free: '20', full: '500', monitoring: '500', agency: '500' },
      {
        feature: 'Findings shown',
        free: '2 detailed',
        full: 'All unlocked',
        monitoring: 'All unlocked',
        agency: 'All unlocked',
      },
      { feature: 'PDF report', free: '—', full: 'Yes', monitoring: 'Yes', agency: 'Yes' },
      { feature: 'Correction checklist', free: '—', full: 'Yes', monitoring: 'Yes', agency: 'Yes' },
    ...
    chooseItems: [
      {
        title: 'Just discovering a Merchant Center issue?',
        body: 'Run the Free Scan first. If the preview findings look relevant, upgrade to Full Audit to unlock the full evidence and checklist.',
      },
      {
    ...
    agencyStripeNotConfigured: 'Agency checkout is temporarily unavailable.',
  },
  scan: {
  ...
  dashboard: {
    ...
    mcComingSoonTitle: 'Merchant Center connection',
    mcComingSoonBody:
      'Coming soon. Weekly site scans and alerts are already available with your subscription.',
    mcComingSoonBadge: 'Coming soon',
